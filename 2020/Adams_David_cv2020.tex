...
%
% Copyright (C) 2020 David P. Adams dpadams@fullerton.edu
%
...
\begin{itemize}\leftmargin=2pt\labelindent=5pt\itemindent=-15pt
	\item \item ``Crude Contempt: Examining Local Pushback to Oil and Gas Development in California'' with Jonathan Fisk and Zachary Mahafza; under review at \emph{Politics \& Policy}.
...
\item Colorado Fracking Spills and Accidents: An Environmental Justice Perspective, with Jonathan Fisk, Zachary Mahafza, and Hanna Krawczyk. 
...
\subsection*{Refereed Presentations}
	\begin{itemize}\leftmargin=2pt\labelindent=5pt\itemindent=-15pt
		...
		\item ``American Indian Youth and Substance Use: Multilevel Analysis of School Related Factors,'' paper co-authored with Veronica Herrera and Lidia E. Nu\~no and chosen through a competitive selection process for presentation as part of the special event ``Adolescence in the Context of Domestic and Global Diversity'' at the Society of Research on Adolescence (SRA) Biennial Meeting, San Diego, Calif., March 2020. Canceled due to COVID-19. 
		
		\item ``Watershed Governance: Internal and External Boundaries of Complex Institutional Arrangements, accepted for presentation at the American Society for Public Administration Annual Meeting, Anaheim, Calif., April 2020. Canceled due to COVID-19.
...
\item California State University, Fullerton, Division of Politics, Administration \& Justice, Assistant Professor.
	\begin{itemize}
		...
		\item Introduction to Public Policy, POSC 315
...
\item Auburn University, Department of Political Science, Instructor of Record, Undergraduate Courses, Summer 2013--Spring 2016.
  	\begin{itemize}\leftmargin=2pt\labelindent=5pt\itemindent=-15pt
			...
			\item Undergraduate Research Methods  
			\item Introduction to Political Theory
			\item American Government
			\item Public Policy Process
		 	\end{multicols}				
	\end{itemize}
...
\section*{Professional Development and Other Training}
\begin{itemize}
\item Interuniversity Consortium for Political and Social Research (ICPSR) Summer Program in Quantitative Methods of Social Research, University of Michigan, 2012. 
	\begin{itemize}
		...
		\item R and Stata Workshops
		\end{multicols}
	\end{itemize}
	
\item Canvas: Beginner and Advanced Quiz Development Training
\item Introduction to Camtasia
\item \emph{Data Camp} workshops on R and Python statistical analysis
...
\section*{Division Service at California State University, Fullerton}
	\begin{itemize}
		\item Division of Politics, Administration, and Justice Curriculum Committee, 2020--present.
...
\section*{University Service at California State University, Fullerton}
	\begin{itemize}
		\item Faculty Lead, G.E. Assessment Faculty Learning Community, 2020--present
		\item Member, G.E. Assessment Faculty Learning Community, 2019--2020
