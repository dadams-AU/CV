...
%
% Copyright (C) 2016 David P. Adams dza0003@auburn.edu
%
...
\begin{itemize}
  \item PhD, Public Policy and Public Administration, Auburn University, May 2016.
  ...
  \item BS, Political Science and Government, Kennesaw State University, May 2008.
...
\item Sequencing MPA Courses: A Case Study in Core Competency Learning.
\item Measuring Water Quality Outcomes from Watershed Partnership Activity in the United States.
\item Refining Watershed Partnership Typologies.
\item City Manager Fellowship Program: Professional Development of MPA Student (with Meriem Hodge).
\item Environmental Outcomes of Local Watershed Information Networks.
\item Outstanding Programs and Potential Policy Learning Across the States (with Cynthia Bowling and Kisha Hardwick).
\item Collaborative Natural Resource Management and Environmental Justice.
\end{itemize}
...
\section*{Division Service at California State University, Fullerton}
	\begin{itemize}
		\item MPA Assessment and Accreditation Coordinator, 2017--present.
		...
		\item Graduation Commencement Committee member, 2017.
	\end{itemize}
