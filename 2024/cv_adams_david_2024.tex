...
\subsubsection*{Books}
\begin{itemize}\leftmargin=2pt\labelindent=5pt\itemindent=-15pt\leftmargin=2pt\labelindent=5pt\itemindent=-15pt
  \item Adams, David P., Jonathan M. Fisk, and John Morris. Forthcoming. \emph{Navigating Water Quality Outcomes in American Watersheds}. Under Contract with Cambridge University Press: New York, N.Y.
\end{itemize}
